...
impl TryFrom<core_extraction::ExtractionProvenance> for ExtractionProvenance {
    ...
    fn try_from(
        ...
        Ok(Self {
            ...
            byte_range: value
                .byte_range
                .map(ExtractionByteRange::try_from)
                .transpose()?,
        })
    }
}
...
impl TryFrom<core_extraction::ExtractionByteRange> for ExtractionByteRange {
    type Error = ExtractionError;

    fn try_from(
        value: core_extraction::ExtractionByteRange,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            start: u64::try_from(value.start).map_err(runtime_error)?,
            end: u64::try_from(value.end).map_err(runtime_error)?,
        })
    }
}
...
impl From<core_extraction::PartKind> for PartKind {
    fn from(value: core_extraction::PartKind) -> Self {
        match value {
            ...
            core_extraction::PartKind::Code => Self::Code,
            ...
            core_extraction::PartKind::Markup => Self::Markup,
