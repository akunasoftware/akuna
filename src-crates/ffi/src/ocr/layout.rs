...
//!
//! ```rust,no_run
//! # async fn example() -> Result<(), akuna_ffi::ocr::layout::LayoutError> {
//! let detector = akuna_ffi::ocr::layout::load_layout_detector(None).await?;
...
use akuna_core::ocr::layout as core_layout;
